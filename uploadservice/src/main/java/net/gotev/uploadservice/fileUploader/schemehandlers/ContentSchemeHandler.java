package net.gotev.uploadservice.fileUploader.schemehandlers;
...
import net.gotev.uploadservice.fileUploader.ContentType;
...
class ContentSchemeHandler implements SchemeHandler {
    ...
    private String getUriName(Context context) {
        ...
        cursor.moveToFirst();
        String name = cursor.Utils.getString(nameIndex);
        cursor.close();
        return name;
    }
