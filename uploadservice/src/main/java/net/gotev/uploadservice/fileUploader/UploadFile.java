package net.gotev.uploadservice.fileUploader;
...
import net.gotev.uploadservice.fileUploader.schemehandlers.SchemeHandler;
import net.gotev.uploadservice.fileUploader.schemehandlers.SchemeHandlerFactory;
