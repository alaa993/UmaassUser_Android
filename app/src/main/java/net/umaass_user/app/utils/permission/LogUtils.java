package net.umaass_user.app.utils.permission;
...
public final class LogUtils {
    ...
    private static void printDeviceInfo(final String filePath) {
        ...
        int versionCode = 0;
        try {
            PackageInfo pi = net.umaass_user.app.utils.permission.UtilsLib.getApp()
                                                                          .getPackageManager()
                                                                          .getPackageInfo(net.umaass_user.app.utils.permission.UtilsLib.getApp().getPackageName(), 0);
            if (pi != null) {
    ...
    public static class Config {
        ...
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && net.umaass_user.app.utils.permission.UtilsLib.getApp().getExternalCacheDir() != null)
                mDefaultDir = net.umaass_user.app.utils.permission.UtilsLib.getApp().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                mDefaultDir = net.umaass_user.app.utils.permission.UtilsLib.getApp().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
