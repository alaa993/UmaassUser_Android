...
public class DatePickerDialog extends DialogFragment implements
    ...
    private static final String KEY_HIGHLIGHTED_DATES = "highlighted_dates";
    private static final String KEY_NOTE_DATES = "note_dates";
    ...
    private ArrayList<String> repeatNoteDays;
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putSerializable(KEY_HIGHLIGHTED_DATES, highlightedDates);
        outState.putSerializable(KEY_NOTE_DATES, noteDate);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.mdtp_date_picker_dialog_full, null);
        ...
        if (savedInstanceState != null) {
            ...
            highlightedDates = savedInstanceState.getStringArrayList(KEY_HIGHLIGHTED_DATES);
            noteDate = savedInstanceState.getStringArrayList(KEY_NOTE_DATES);
        ...
        mDayPickerDescription = res.Utils.getString(R.string.mdtp_day_picker_description);
        mSelectDay = res.Utils.getString(R.string.mdtp_select_day);
        mYearPickerDescription = res.Utils.getString(R.string.mdtp_year_picker_description);
        mSelectYear = res.Utils.getString(R.string.mdtp_select_year);
        ...
        okButton.setTypeface(TypefaceHelper.get(activity, "iran-sans-light_baz"));
        ...
        cancelButton.setTypeface(TypefaceHelper.get(activity, "iran-sans-light_baz"));
...
*/
    ...
    public void setHighlightedDates(ArrayList<String> highlightedDates) {
        this.highlightedDates = highlightedDates;
    }

    public void setNoteDates(ArrayList<String> noteDate) {
        this.noteDate = noteDate;
    }

    public void setRepeatNoteDays(ArrayList<String> repeatNoteDays) {
        this.repeatNoteDays = repeatNoteDays;
    }
    ...
    @Override
    public ArrayList<String> getHighlightedDate() {
        return highlightedDates;
    }

    @Override
    public ArrayList<String> getRepeatNoteDays() {
        return repeatNoteDays;
    }

    @Override
    public ArrayList<String> getNoteDate() {
        return noteDate;
    }
