...
public class DatePickerDialog extends DialogFragment implements
   ...
   /*     WindowManager.LayoutParams wmlp = getDialog().getWindow().getAttributes();
            ...
            public void onClick(View v) {
                ...
                if (mCallBack != null) {
                    mCallBack.onDateSet(DatePickerDialog.this, mPersianCalendar.getPersianYear(),
                            formatToMilitary(mPersianCalendar.getPersianMonth()), formatToMilitary(mPersianCalendar.getPersianDay()));
                }
                dismiss();
            }
        });
    ...
    private int formatToMilitary(int i) {
        String s = (i < 9) ? "0" + i : String.valueOf(i);
    ...
    private void updateDisplay(boolean announce) {
        ...
        mYearView.setText(LanguageUtils.
                getPersianNumbers(String.valueOf(mPersianCalendar.getPersianYear())));
        if (getActivity() != null) {
            Typeface typeface=TypefaceHelper.get(getActivity(), "iran-sans-light_baz");
            if (mDayOfWeekView != null) {
                mDayOfWeekView.setTypeface(typeface);
            }
