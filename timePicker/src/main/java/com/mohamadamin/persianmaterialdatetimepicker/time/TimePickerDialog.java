...
public class TimePickerDialog extends DialogFragment implements OnValueSelectedListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(KEY_HOUR_OF_DAY)
            ...
            mTitle = savedInstanceState.Utils.getString(KEY_TITLE);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mHourPickerDescription = res.Utils.getString(R.string.mdtp_hour_picker_description);
        mSelectHours = res.Utils.getString(R.string.mdtp_select_hours);
        mMinutePickerDescription = res.Utils.getString(R.string.mdtp_minute_picker_description);
        mSelectMinutes = res.Utils.getString(R.string.mdtp_select_minutes);
        ...
        mOkButton.setTypeface(TypefaceHelper.get(getDialog().getContext(),"iran-sans-light_baz"));
        ...
        mCancelButton.setTypeface(TypefaceHelper.get(getDialog().getContext(),"iran-sans-light_baz"));
        ...
        mDoublePlaceholderText = res.Utils.getString(R.string.mdtp_time_placeholder);
        mDeletedKeyFormat = res.Utils.getString(R.string.mdtp_deleted_key);
