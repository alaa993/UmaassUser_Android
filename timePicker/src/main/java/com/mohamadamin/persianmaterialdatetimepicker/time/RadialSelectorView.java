    ...
    public void initialize(Context context, boolean is24HourMode, boolean hasInnerCircle,
        ...
        if (hasInnerCircle) {
            mInnerNumbersRadiusMultiplier =
                    Float.parseFloat(res.Utils.getString(R.string.mdtp_numbers_radius_multiplier_inner));
            mOuterNumbersRadiusMultiplier =
                    Float.parseFloat(res.Utils.getString(R.string.mdtp_numbers_radius_multiplier_outer));
        } else {
            mNumbersRadiusMultiplier =
                    Float.parseFloat(res.Utils.getString(R.string.mdtp_numbers_radius_multiplier_normal));
        }
        mSelectionRadiusMultiplier =
                Float.parseFloat(res.Utils.getString(R.string.mdtp_selection_radius_multiplier));
