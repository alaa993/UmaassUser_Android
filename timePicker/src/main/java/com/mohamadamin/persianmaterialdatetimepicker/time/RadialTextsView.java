...
public class RadialTextsView extends View {
    ...
    public void initialize(Resources res, String[] texts, String[] innerTexts,
        ...
        mTypefaceLight = Typeface.createFromAsset(getContext().getAssets(), "fonts/IRAN Sans Light_ba.ttf");
        mTypefaceRegular = Typeface.createFromAsset(getContext().getAssets(), "fonts/IRAN Sans Light_ba.ttf");
        ...
        if (is24HourMode) {
            mCircleRadiusMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_circle_radius_multiplier_24HourMode));
        } else {
            mCircleRadiusMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_circle_radius_multiplier));
            mAmPmCircleRadiusMultiplier =
                    Float.parseFloat(res.Utils.getString(R.string.mdtp_ampm_circle_radius_multiplier));
        }
        ...
        if (mHasInnerCircle) {
            mNumbersRadiusMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_numbers_radius_multiplier_outer));
            mTextSizeMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_text_size_multiplier_outer));
            mInnerNumbersRadiusMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_numbers_radius_multiplier_inner));
            mInnerTextSizeMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_text_size_multiplier_inner));

            mInnerTextGridHeights = new float[7];
            mInnerTextGridWidths = new float[7];
        } else {
            mNumbersRadiusMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_numbers_radius_multiplier_normal));
            mTextSizeMultiplier = Float.parseFloat(
                    res.Utils.getString(R.string.mdtp_text_size_multiplier_normal));
        }
