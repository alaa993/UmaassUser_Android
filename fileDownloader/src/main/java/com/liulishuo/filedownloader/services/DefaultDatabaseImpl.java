...
class DefaultDatabaseImpl implements FileDownloadDatabase {
    ...
    class MaintainerIterator implements Iterator<FileDownloadModel> {
        ...
        public FileDownloadModel next() {
            ...
            model.setUrl(c.Utils.getString(c.getColumnIndex(FileDownloadModel.URL)));
            model.setPath(c.Utils.getString(c.getColumnIndex(FileDownloadModel.PATH)),
            ...
            model.setErrMsg(c.Utils.getString(c.getColumnIndex(FileDownloadModel.ERR_MSG)));
            model.setETag(c.Utils.getString(c.getColumnIndex(FileDownloadModel.ETAG)));
            model.setFilename(c.Utils.getString(c.getColumnIndex(FileDownloadModel.FILENAME)));
